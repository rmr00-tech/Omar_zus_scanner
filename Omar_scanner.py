#!/usr/bin/python
# Hello World! my scanner is here :)
## -*- coding: utf-8 -*-
...
#
# Author	 : Omar Hamdy
# Tool 		 : Omar_zus_scanner
# Usage		 : ./zus.py example.com (or) python zus.py example.com
...
tools_fix = [
					...
					[15, "By exploiting this vulnerability, an attacker will be able gain access to sensitive data in a n encrypt
